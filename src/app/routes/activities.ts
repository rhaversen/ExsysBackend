 ...
 * @param {string[]} req.body.priorityRooms - The rooms that are promoted for this activity.
 ...
 * @param {string[]} [req.body.priorityRooms] - The new rooms that are promoted for this activity (optional).
